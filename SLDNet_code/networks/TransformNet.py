...
class TransformNet(nn.Module):
    ...
    def __init__(self, opts, nc_in, nc_out):
        ...
        ## convolution layers
        self.conv1a = ConvLayer(3 + 3, nf * 1, kernel_size=3, stride=1, bias=use_bias, norm=opts.norm) ## input: P_t, O_t-1
        self.conv1b = ConvLayer(3 + 3, nf * 1, kernel_size=3, stride=1, bias=use_bias, norm=opts.norm) ## input: I_t, I_t-1
        ...
        self.deconv3 = ConvLayer(nf * 2, nc_out, kernel_size=3, stride=1) ## output one channel mask
